...
describe('classifyUa', () => {
  it('classifies bots and crawlers', () => {
  ...
  it('classifies Safari when the user agent does not contain Chrome', () => {
    const safari =
  ...
  it('returns unknown for null, empty, and unrecognized user agents', () => {
